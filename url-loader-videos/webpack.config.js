...
module .exports = {
    ...
    output: {                                           /* Asigna el 'output' */
        ...
        publicPath: './dist/'                           /* Ruta apartir de la cual buscará los archivos generados */
    },
    module: {
        rules: [
            ...
            /* Nuevo Loader para la configuración de soporte de videos */
            {
                test: /\.(mp4|webm)$/,  /* Expresión regular: para identificar el tipo de archivo que deseamos reconocer */
                use: {
                    loader: 'url-loader',              /* (Definición explicita de un loader requiere un nombre de key 'loader') */
                    options: {
                        limit: 1000000,                /* Hasta que límite (en bytes) de peso va a realizar una transformación a base 64 (convertirlas a código y ponerlas junto con nuestro JavaScript) */
                        name: 'videos/[name].[hash].[ext]'   /* Indicamos path donde se alojarán los archivos que no están dentro del límite establecido de tamaño */
                    }
                }
            }
        ]
